...
I thought that I would create a simple blog that could be used to document my Android development journey. I just wanted a very simple blog implementation, so I found Chad Baldwin's example of using GitHub Pages to build a fairly simple blog very useful:
